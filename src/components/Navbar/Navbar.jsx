      ...
      <div className='container navbar-content flex'>
        <div className='brand-and-toggler flex flex-sb'>
          <Link to = "/book" className='navbar-brand flex'>
            {/* <img src = {logoImg} alt = "site logo" height={'90px'} /> */}
            <span className='text-uppercase fw-7 fs-24 ls-1'>bo<span className='ok'>ok</span>ly</span>
          </Link>
        ...
        <div className={toggleMenu ? "navbar-collapse show-navbar-collapse" : "navbar-collapse"}>
          <ul className = "navbar-nav">
            ...
            {/* <li className='nav-item'>
              <Link to = "/account" className='nav-link text-uppercase text-white fs-22 fw-6 ls-1'>Profile</Link>
            </li> */}
            <li className='nav-item'>
